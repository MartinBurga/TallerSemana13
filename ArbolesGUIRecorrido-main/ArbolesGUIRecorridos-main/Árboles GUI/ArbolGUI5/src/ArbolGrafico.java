    ...
    public void dibujarArbol(Graphics2D g2d, Nodo nodo, int x, int y, int dimensionX, int dimensionY) {
        if (nodo != null) {
            ...
            if (nodo.medioizq != null) {
                int nuevoX = x - dimensionX / 2;
                int nuevoY = y + dimensionY;
                g2d.drawLine(x, y, nuevoX, nuevoY);
                dibujarArbol(g2d, nodo.medioizq, nuevoX, nuevoY, dimensionX / 2, dimensionY);
            }
            ...
            if (nodo.medioder != null) {
                ...
                int nuevoY = y + dimensionY;
                g2d.drawLine(x, y, nuevoX, nuevoY);
                dibujarArbol(g2d, nodo.medioder, nuevoX, nuevoY, dimensionX / 2, dimensionY);
            }
        }
}
}
